...
% Caso recursivo: Búsqueda en profundidad
...
%%%% Consulta para VERIFICAR EL FUNCIONAMIENTO %%%%
%%% Camino desde Craiova hasta Fagaras %%%%
% go(craiova,fagaras).

%%%% Camino encontrado %%%%
% craiova -> dobreta (120 km)
% dobreta -> mehadia (75 km)
% mehadia -> lugoj (70 km)
% lugoj -> timisoara (111 km)
% timisoara -> arad (118 km)
% arad -> sibiu (140 km)
% sibiu -> fagaras (99 km)
% Distancia total: 733 km